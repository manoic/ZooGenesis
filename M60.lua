...
local S = 
	{
		...
		ShellOutSettings = {
			...
			Vel = 5000;
			RotVel = 15;
			RotSpawn = CFrame.Angles(1.5707963267948966, 0, 0);
			ShellSound = true;	
		...
		BulletSettings = {
			...
			TracerOffset0 = Vector3.new(-0.225, -0.025, -0.205); 
			TracerOffset1 = Vector3.new(0.225, 0.025, 0.025);
		...
		AimSettings = {
			...
			Offset = CFrame.new(-0.5615, 0.242, 0.6) * CFrame.Angles(0.003490658503988659, 0, 0);

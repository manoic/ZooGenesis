...
local S = 
	{
		...
		BulletSettings = {
			...
			TracerOffset0 = Vector3.new(-0.125, -0.025, -0.205); 
			TracerOffset1 = Vector3.new(0.125, 0.025, 0.025);
		...
		AimSettings = {
			...
			Offset = CFrame.new(-0.379,0.333,0.15) * CFrame.Angles(math.rad(-0.55),math.rad(0.03),0);
			...
			ArmOffset = {
				Enabled = true;
				rArmOffset = CFrame.new(0.3,0.35,-0.2) *  CFrame.Angles(0,math.rad(5),0);
				lArmOffset = CFrame.new(-0.45,0.4,0.4);
			};
			...
			ADS_ArmsOffset = CFrame.new(-0.15, 0.45, -0.05) * CFrame.Angles(math.rad(12),0,0);

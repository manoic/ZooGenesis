...
local S = 
{
	...
	BulletsPerShot	= 	1;
	Spread		= 		40;
		CrouchSpreadReduction = 0.87;
		WalkSpreadIncrease = 1.8;
	...
	RunAnimSpeed = 1.45;
	RunOffset = Vector3.new(0,-0.2,0.5);
	...
	BulletSettings = {
		...
		LightEnabled = false;
		LightBrightness = 4;
		LightColor = Color3.fromRGB(255, 117, 890);
		LightRange = 10;
		LightShadows = true;
	...
	AngleY_Min = -1.8; -- this is x idk
	AngleY_Max = 1.8; --	this is x idk
	AngleZ_Min = -1; --	z
	AngleZ_Max = 1; --	z

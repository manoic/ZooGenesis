...
local S = 
{
	...
	RunAnimSpeed = 1.5;
	RunOffset = Vector3.new(0.35,-0.25,0.5);
	...
	AimSettings = {
		...
		Offset = CFrame.new(-0.555,0.35,0.1) * CFrame.Angles(math.rad(0),math.rad(0),0);
		...
		ADS_ArmsOffset = CFrame.new(-0.85, 0.45, 0.05) * CFrame.Angles(math.rad(12),0,0);
	...
	CameraRecoilingEnabled = true;
		...
		AngleY_Min = -0.75; -- this is x idk
		AngleY_Max = 0.75; --	this is x idk
		AngleZ_Min = -1.5; --	z
		AngleZ_Max = 1.5; --	z

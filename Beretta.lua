...
local S = 
{
	...
	AimSettings = {
		...
		Offset = CFrame.new(-0.565,0.497,0.2) * CFrame.Angles(math.rad(-0.3),math.rad(0),0);
	...
	CameraRecoilingEnabled = true;
		...
		AngleY_Min = -1.15; -- this is x idk
		AngleY_Max = 1.15; --	this is x idk
		AngleZ_Min = -2; --	z
		AngleZ_Max = 2; --	z

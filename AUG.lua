...
local S = 
	{
		...
		AimSettings = {
			...
			Offset = CFrame.new(-0.3587,0.14,0.4) * CFrame.Angles(math.rad(-0.175),math.rad(0),math.rad(0));
		...
		Recoil = 26;
		AngleX_Min = 5; --	this is y basically idk
		AngleX_Max = 5; --	this is y basically idk
		AngleY_Min = -0.6; -- this is x idk
